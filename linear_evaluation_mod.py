...
if __name__ == "__main__":
    ...
    config = yaml_config_hook("./config/config_mod.yaml")
    ...
    if args.dataset == "STL10":
        ...
        train_dataset.labels = [1 if target==1 else 0 for target in train_dataset.labels]
        test_dataset.labels = [1 if target==1 else 0 for target in test_dataset.labels] 
    ...
    # added CIFAR2
        ...
        train_dataset.targets = [1 if target==1 else 0 for target in train_dataset.targets]    
        test_dataset.targets = [1 if target==1 else 0 for target in test_dataset.targets] 
